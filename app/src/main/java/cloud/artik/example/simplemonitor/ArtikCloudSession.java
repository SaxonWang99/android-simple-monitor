...
public class ArtikCloudSession {
    ...
    private final static String DEVICE_ID = "9dca525b847442d18bfd1c6b1ef32320";
    private final static String DEVICE_TOKEN = "05625cc3d38d44a488e1e2bbbd88d270";
        ...
        try {
            mFirehoseWS = new FirehoseWebSocket(DEVICE_TOKEN, DEVICE_ID, null, null, null, new ArtikCloudWebSocketCallback() {
                ...
                public void onMessage(MessageOut messageOut) {
                    ...
                    intent.putExtra(NOTIFICATION, createNotification(ourContext));
                    LocalBroadcastManager.getInstance(ourContext).sendBroadcast(intent);
                }
    ...
    private Notification createNotification(Context ctx){
        ...
        Notification notification = new Notification.Builder(ctx)
                ...
                .setContentTitle("Flame Monitor Notification")
                .setContentText("There is a fire detected in your house.")
                .setContentIntent(pi)
                .setAutoCancel(false)
                .build();
